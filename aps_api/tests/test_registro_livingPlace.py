...
class RegistroLivingPlace(TestCase):
    def tearDown(self):
        LivingPlace.objects.all().delete()
        
    def setUp(self):
        self.client = Client()
        self.url = '/api/living_place/add/'
        file_path = os.path.join(os.path.dirname(__file__), './responses/data_livingPlace.json')
    ...
    def test_type_living_place_valido(self):
        self.tearDown()

        LivingPlace.objects.create(
        ...
        self.assert_data['type_living_place'] = 13
