...
class RegistroFamilyContext(TestCase):
    def tearDown(self):
    ...
    def setUp(self):
        self.client = Client()
        self.url = '/api/family_context/add/'
        file_path = os.path.join(os.path.dirname(__file__), './responses/data_familyContext.json')
        ...
        self.family = Family.objects.create(
            ...
            number_family= "FAM12345"
        )
        
        self.assert_data['family'] = self.family.id
