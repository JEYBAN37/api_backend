...
class UserRegisterSerializers(serializers.ModelSerializer):
    ...
    def update(self, instance, validated_data):
        ...
        # Actualizar is_active solo si se proporciona en la solicitud
        if active is not None:
            ...
            try:
                ...
                recipient_list = [instance.email]  # Asegúrate de tener el campo email en el modelo User o Pollster asociado
